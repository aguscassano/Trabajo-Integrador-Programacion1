...
# === HELPERS (Funciones de ayuda para validación y ordenamiento - Integrante B) ===
...
def obtener_entero_positivo(prompt):
    while True:
...
def agregar_pais(lista_paises):
    ...
    if not encontrado:
        ...
        poblacion = obtener_entero_positivo(f"Ingrese la población de {nombre}: ")
        superficie = obtener_entero_positivo(f"Ingrese la superficie (km²) de {nombre}: ")
...
def actualizar_pais(lista_paises):
    ...
    if pais_encontrado:
        ...
        nueva_poblacion = obtener_entero_positivo(f"Ingrese la NUEVA población (actual: {pais_encontrado['poblacion']: ,}): ")
        nueva_superficie = obtener_entero_positivo(f"Ingrese la NUEVA superficie km² (actual: {pais_encontrado['superficie']: ,}): ")
...
def mostrar_estadisticas(lista_paises):
    ...
    print("\n--- Superficie ---")
    print(f"Promedio de superficie: {promedio_s
uperficie:,.2f} km²")
